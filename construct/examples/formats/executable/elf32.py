...
def elf32_body(ElfInt16, ElfInt32):
    ...
    elf32_section_header = Struct(
        ...
        "align" / ElfInt32,
        "entry_size" / ElfInt32,
        "data" / OnDemandPointer(this.offset,
            HexDump(Bytes(this.size))
        ),
    )
...
elf32_body_little_endian = elf32_body(Int16ul, Int32ul)
elf32_body_big_endian = elf32_body(Int16ub, Int32ub)

elf32_file = Struct(
    "identifier" / Struct(
        "magic" / Const(b"\x7fELF"),
    ...
    Embedded(IfThenElse(this.identifier.encoding == "LSB",
